...
const CreatorCard = ({ creatorImage, rank, creatorName, creatorEths }) => (
  <div
    className="min-w-190 minlg:min-w-240 dark:bg-nft-black-3
    bg-white border dark:border-nft-black-3 border-nft-grey-1 rounded-3xl
  ...
  >
    ...
    <div className="mt-3 minlg:mt-7 text-center flexCenter flex-col">
      ...
      <p
        className="mt-1 font-poppins dark:text-white text-nft-black-1 font-semibold
      text-base"
      >
